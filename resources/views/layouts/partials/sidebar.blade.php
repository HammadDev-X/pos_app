...
<aside class="main-sidebar sidebar-dark-primary elevation-4 pos-sidebar">
    ...
    <a href="{{route('home')}}" class="brand-link">
        <img src="{{ asset('images/logo.png') }}" alt="Musa Jan logo" class="brand-image img-circle elevation-3"
             style="opacity: .8">
        <span class="brand-text font-weight-light">Musa Jan</span>
    </a>
