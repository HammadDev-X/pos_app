    ...
    <div class="card-body">
        ...
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="sku" class="form-control @error('sku') is-invalid @enderror" id="sku" placeholder="SKU" value="{{ old('sku') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="short_code" class="form-control @error('short_code') is-invalid @enderror" id="short_code" value="{{ old('short_code') }}">
                @error('short_code')
                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" name="minimum_stock_level" class="form-control @error('minimum_stock_level') is-invalid @enderror" id="minimum_stock_level" value="{{ old('minimum_stock_level', 0) }}">
            ...
            <div class="form-group form-check">
                ...
                <input type="checkbox" class="form-check-input" id="track_stock" name="track_stock" value="1" {{ old('track_stock', 1) ? 'checked' : '' }}>
                <label class="form-check-label" for="track_stock">Track Stock</label>
            </div>

            <div class="form-group form-check">
                <input type="hidden" name="is_quick_item" value="0">
                <input type="checkbox" class="form-check-input" id="is_quick_item" name="is_quick_item" value="1" {{ old('is_quick_item') ? 'checked' : '' }}>
