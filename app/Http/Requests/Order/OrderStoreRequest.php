...
class OrderStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'payment_method' => ['required', 'string', 'in:cash,jazzcash,easypaisa,cash_account,loan,cash_loan'],
            'payments' => ['nullable', 'array'],
            'payments.*.method' => ['required_with:payments', 'string', 'in:cash,jazzcash,easypaisa,account'],
            'payments.*.amount' => ['required_with:payments', 'numeric', 'min:0', 'decimal:0,2'],
            'customer_balance_payment' => ['nullable', 'numeric', 'min:0', 'decimal:0,2'],
